...
//		depotOK = zoneDeJeu.estDepotAutorise(CartesI.FEU_ROUGE);
//		System.out.println("d�p�t ok ? " + depotOK);
//		if (depotOK) {
//			zoneDeJeu.deposer(CartesI.FEU_ROUGE);
//		}
...
//		depotOK = zoneDeJeu.estDepotAutorise(CartesI.FEU_VERT);
//		System.out.println("d�p�t ok ? " + depotOK);
//		if (depotOK) {
//			zoneDeJeu.deposer(CartesI.FEU_VERT);
//		}
//		System.out.println("peut avancer ? " + zoneDeJeu.peutAvancer());
//		// panne d'essence
...
//			peut avancer ? true
		...
		depotOK = zoneDeJeu.estDepotAutorise(CartesI.PRIORITAIRE);
		System.out.println("d�p�t ok ? " + depotOK);
		if (depotOK) {
			zoneDeJeu.deposer(CartesI.PRIORITAIRE);
		}
		System.out.println("peut avancer ? " + zoneDeJeu.peutAvancer());
		// accident
		System.out.println("Deposer carte attaque - accident");
